...
const Settings = ({ user }) => {
    ...
    return <div className="flex flex-1 flex-col gap-6 min-h-screen py-8 px-4 mx-auto mt-10 max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <SettingsAttribute type="twitter" displayName="Gmail Account" value={twitterAccount} linkAction={handleLinkTwitterAccount} loading={twitterAccountLoading} />
        <SettingsAttribute type="twitter" displayName="Google Tasks Account" value={twitterAccount} linkAction={handleLinkTwitterAccount} loading={twitterAccountLoading} />
        <SettingsAttribute type="twitter" displayName="Google Meet Account" value={twitterAccount} linkAction={handleLinkTwitterAccount} loading={twitterAccountLoading} />
        <SettingsAttribute type="twitter" displayName="Slack Account" value={twitterAccount} linkAction={handleLinkTwitterAccount} loading={twitterAccountLoading} />
        <br />
